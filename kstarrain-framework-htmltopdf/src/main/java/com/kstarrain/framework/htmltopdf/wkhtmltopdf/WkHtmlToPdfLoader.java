package com.kstarrain.framework.htmltopdf.wkhtmltopdf;
...
/**
 * @author: DongYu
 * @create: 2020-04-08 15:05
 * @description:
 */
public class WkHtmlToPdfLoader {

    private static final File tmpDir = new File(System.getProperty("java.io.tmpdir"), "io.wkhtmltopdf");
    ...
    static WkHtmlToPdf load() {
        ...
        WkHtmlToPdf instance = Native.loadLibrary(libraryFile.getAbsolutePath(), WkHtmlToPdf.class);
